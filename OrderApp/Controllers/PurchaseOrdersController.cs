...
namespace OrderApp.Controllers
{
    public class PurchaseOrdersController : Controller
    {
        ...
        public PurchaseOrdersController(OrderDBContext context)
        {
            _context = context;
        }
        ...
        {
            var orderDBContext = _context.PurchaseOrders.Include(p => p.Customer);
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,DateOfDelivery,Status,AmountDue,DateCreated,CreatedBy,Timestamp,UserId,IsActive")] PurchaseOrder purchaseOrder)
        {
